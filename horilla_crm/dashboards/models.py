...
from horilla_crm.dashboards.methods import limit_content_types
...
class DashboardFolder(HorillaCoreModel):
    ...
    def get_detail_view_url(self):
        ...
        return reverse_lazy(
            "dashboards:dashboard_folder_detail_list", kwargs={"pk": self.pk}
        )
...
class Dashboard(HorillaCoreModel):
    ...
    def get_favourite_toggle_url(self):
        ...
        return reverse_lazy(
            "dashboards:dashboard_toggle_favourite", kwargs={"pk": self.pk}
        )
...
class DashboardComponent(HorillaCoreModel):
    ...
    metric_field = models.CharField(
        max_length=100, blank=True, null=True, verbose_name=_("Metric Field")
    )
